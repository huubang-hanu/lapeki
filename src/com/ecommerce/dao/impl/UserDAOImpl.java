...
public class UserDAOImpl implements UserDAO {
	...
	public void insertUser(User user) {
		...
		int roleID = 0;
		String gender = null;
		String sql = "INSERT INTO person(user_name, user_password, user_fullname, user_phone, user_email, user_address, gender, user_dob, user_role) "
				+ "VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";
	...
	public boolean updateUser(User user) {
		...
		String sql = "UPDATE person SET user_name = ? , user_password = ?, user_fullname=?, user_phone=?, "
				+ "user_email=?, user_address=?, gender=?, user_dob=?, user_role=? WHERE user_id=?";
	...
	public List<User> searchUserByKeyword(String keyword) {
		connection = DatabaseConnection.getConnection();
		String sql = "SELECT * FROM person WHERE user_name LIKE ? " + "OR user_email LIKE ? OR phone LIKE ?";
		List<User> list = new ArrayList<User>();
	...
	public boolean checkExistPhone(String phone) {
		connection = DatabaseConnection.getConnection();
		boolean isDuplicated = false;
		String sql = "SELECT * FROM person WHERE user_phone = ?";
		try {
			ps = connection.prepareStatement(sql);
